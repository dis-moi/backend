    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('
            CREATE TABLE relay (
                ...
                relayed_by_id INT NOT NULL,
                relayed_at DATETIME NOT NULL, 
                PRIMARY KEY(relayed_by_id, notice_id)
            )
            DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci 
            ENGINE = InnoDB
        ');
        $this->addSql('ALTER TABLE relay ADD CONSTRAINT FK_5D3AE2B97A19A357 FOREIGN KEY (relayed_by_id) REFERENCES contributor (id)');
        $this->addSql('ALTER TABLE relay ADD CONSTRAINT FK_5D3AE2B97D540AB FOREIGN KEY (notice_id) REFERENCES notice (id)');
        $this->addSql('CREATE INDEX INDEX_RELAY_CONTRIBUTOR ON relay (relayed_by_id)');
