 ...
 */
class Version20161214142902 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE feedback CHANGE context_url context_url VARCHAR(1000) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE feedback CHANGE context_url context_url DATETIME DEFAULT NULL');
    }
}
