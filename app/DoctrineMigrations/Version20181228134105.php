...
class Version20181228134105 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE resource (id INT AUTO_INCREMENT NOT NULL, recommendation_id INT DEFAULT NULL, editor_id INT DEFAULT NULL, `label` VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, description VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci, url VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, UNIQUE INDEX UNIQ_BC91F416D173940B (recommendation_id), INDEX IDX_BC91F4166995AC4C (editor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
